...
function generate_index() {
 ...
 $house_listing = get_property_listing_by_id_if_session_user_owned($connection, $_GET["id"]);
 $connection->close();
 ...
 return sprintf(
  $template,
  $house_listing == null ?
  "Either Session User does not Own Property, or Property Listing Never Existed" :
